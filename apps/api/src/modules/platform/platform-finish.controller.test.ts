...
describe('platform finalization authorization', () => {
  it('denies printing without platform.print.create', async () => {
    ...
    const request = {
      ...
      tenantContext: {
        accountId: '10000000-0000-4000-8000-000000000001', accountKind: 'USER', deviceId: 'test',
        organizationIds: [], permissionVersion: 1,
        tenantId: '10000000-0000-4000-8000-000000000002', tokenId: 'token',
      },
    };
    ...
    expect(decide).toHaveBeenCalledWith(expect.objectContaining({ permissionCode: 'platform.print.create' }));
  });
});
