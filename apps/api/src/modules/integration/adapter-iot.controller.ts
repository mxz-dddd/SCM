...
export class AdapterIotController {
  constructor(
    @Inject(AdapterIotService) private readonly service: AdapterIotService,
  ) {}
  ...
  createAdapter(
    @Body() input: CreateAdapterInput,
    @Headers('idempotency-key') key: string | undefined,
    @Headers('x-correlation-id') correlationId: string,
    @Req() request: TenantRequest,
  ) {
    return this.service.createAdapter(
      input,
  ...
  createAdapterVersion(
    @Param('id') id: string,
    @Body() input: CreateAdapterVersionInput,
    @Headers('idempotency-key') key: string | undefined,
    @Headers('x-correlation-id') correlationId: string,
    @Req() request: TenantRequest,
  ) {
    return this.service.createAdapterVersion(
      id,
      input,
      request.tenantContext,
      metadata(request, correlationId, key),
  ...
  testAdapterVersion(
    ...
    return this.service.testAdapterVersion(
      id,
      input,
      request.tenantContext,
      metadata(request, correlationId, key),
  ...
  publishAdapterVersion(
    ...
    return this.service.publishAdapterVersion(
      id,
      input,
      request.tenantContext,
      metadata(request, correlationId, key),
  ...
  transitionAdapter(
    @Param('id') id: string,
    @Body() input: Parameters<AdapterIotService['transitionAdapter']>[1],
    @Headers('idempotency-key') key: string | undefined,
    @Headers('x-correlation-id') correlationId: string,
    @Req() request: TenantRequest,
  ) {
    return this.service.transitionAdapter(
      id,
      input,
      request.tenantContext,
      metadata(request, correlationId, key),
  ...
  submitAdapterCommand(
    @Body() input: SubmitAdapterCommandInput,
    @Headers('idempotency-key') key: string | undefined,
    @Headers('x-correlation-id') correlationId: string,
    @Req() request: TenantRequest,
  ) {
    return this.service.submitAdapterCommand(
      input,
      request.tenantContext,
      metadata(request, correlationId, key),
    );
  ...
  dispatchAdapterCommand(
    ...
    return this.service.dispatchAdapterCommand(
      id,
      input,
      request.tenantContext,
      metadata(request, correlationId, key),
  ...
  acknowledgeAdapterCommand(
    @Param('id') id: string,
    @Body()
    input: Parameters<AdapterIotService['acknowledgeAdapterCommand']>[1],
    @Headers('idempotency-key') key: string | undefined,
    @Headers('x-correlation-id') correlationId: string,
    @Req() request: TenantRequest,
  ) {
    return this.service.acknowledgeAdapterCommand(
      id,
      input,
      request.tenantContext,
      metadata(request, correlationId, key),
  ...
  transitionDevice(
    @Param('id') id: string,
    @Body() input: Parameters<AdapterIotService['transitionDevice']>[1],
    @Headers('idempotency-key') key: string | undefined,
    @Headers('x-correlation-id') correlationId: string,
    @Req() request: TenantRequest,
  ) {
    return this.service.transitionDevice(
      id,
      input,
      request.tenantContext,
      metadata(request, correlationId, key),
  ...
  rotateDeviceCertificate(
    @Param('id') id: string,
    @Body() input: Parameters<AdapterIotService['rotateDeviceCertificate']>[1],
    @Headers('idempotency-key') key: string | undefined,
    @Headers('x-correlation-id') correlationId: string,
    @Req() request: TenantRequest,
  ) {
    return this.service.rotateDeviceCertificate(
      id,
      input,
      request.tenantContext,
      metadata(request, correlationId, key),
  ...
  issueDeviceCommand(
    @Param('id') id: string,
    @Body() input: Parameters<AdapterIotService['issueDeviceCommand']>[1],
    @Headers('idempotency-key') key: string | undefined,
    @Headers('x-correlation-id') correlationId: string,
    @Req() request: TenantRequest,
  ) {
  ...
  sendDeviceCommand(
    ...
    return this.service.sendDeviceCommand(
      id,
      input,
      request.tenantContext,
      metadata(request, correlationId, key),
...
export class ExternalIotController {
  ...
  @HttpCode(200)
  heartbeat(
    @Body() input: DeviceHeartbeatInput,
    @Headers('idempotency-key') key: string | undefined,
    @Headers('x-correlation-id') correlationId: string,
    @Req() request: Request,
  ) {
  ...
  @HttpCode(202)
  telemetry(
    @Body() input: DeviceTelemetryInput,
    @Headers('idempotency-key') key: string | undefined,
    @Headers('x-correlation-id') correlationId: string,
    @Req() request: Request,
  ) {
  ...
  commandAcknowledgement(
    @Body() input: DeviceCommandAckInput,
    @Headers('idempotency-key') key: string | undefined,
    @Headers('x-correlation-id') correlationId: string,
    @Req() request: Request,
  ) {
    return this.service.acknowledgeDeviceCommand(
      input,
      key,
      correlationId,
      request.ip,
